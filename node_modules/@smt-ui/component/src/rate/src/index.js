...
import {getComputedStyle} from './../../common/utils/index';
...
Component({ // eslint-disable-line
    ...
    created() {
        const {stars, activeColor, sleepColor} = this.data;
    ...
    methods: {
         ...
         */
        touchEnd(e) {
            const {isSliding, disabled} = this.data;
            if (disabled || !isSliding) {
                return;
            }
            const {left, childW} = this.attr.starsParentNode;
