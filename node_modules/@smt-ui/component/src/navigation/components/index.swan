...
<view s-if="loaded" class="container {{isIos ? '' : 'android-patch'}}"
    style="{{utils.computeContainerRect(statusBarHeight, navigationStyle, navigationBarHeight, backgroundColor, opacity, frontColor)}}">
    <view class="content-area"
        style="{{utils.computeContentRect(navigationAreaStyle)}}">
